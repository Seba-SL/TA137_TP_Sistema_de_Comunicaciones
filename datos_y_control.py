...
parametros = utilidades.parametros(True,'FSK',2,None,None,None,None,False,True,True)

trama_binaria, diccionario, simbolos, puntos,mapa,bps = utilidades.transmitir_archivo(archivo_entrada, parametros)

trama_binaria_recibida = canal.efectos_del_canal(trama_binaria,parametros)

utilidades.recibir_archivo(trama_binaria_recibida, diccionario,simbolos,puntos,parametros,mapa,bps)